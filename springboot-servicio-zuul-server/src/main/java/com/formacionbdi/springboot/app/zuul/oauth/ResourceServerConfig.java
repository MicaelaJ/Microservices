...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/api/security/oauth/**").permitAll() // autenticarse
				.antMatchers(HttpMethod.GET, "/api/productos/listar", "api/items/listar", "/api/usuarios/usuarios")
				.permitAll()
				.antMatchers(HttpMethod.GET, "/api/productos/ver/{id}", "api/items/ver/{id}/cantidad/{id}",
		 ...
		 * "/api/usuarios/usuarios/{id}").hasRole("ADMIN") .antMatchers(HttpMethod.PUT,
		 * "/api/productos/editar", "/api/items/editar",
		 * "/api/usuarios/usuarios/{id}").hasRole("ADMIN")
		 * .antMatchers(HttpMethod.DELETE, "/api/productos/eliminar",
		 * "/api/items/eliminar", "/api/usuarios/usuarios/{id}").hasRole("ADMIN")
		 */
	}
